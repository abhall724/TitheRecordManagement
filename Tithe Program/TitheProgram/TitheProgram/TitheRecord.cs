...
{
    public partial class TitheRecord : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (rdoMissions.Checked)
            {
                ...
                strType = "Misc.";
            //this.titheRecordTableAdapter.Update(cmbMember.ToString, dateTime, strCheck, strCheckNumb, decAmount, strCash, strType); 
            
            anyRow["memberID"] = memberID;
            anyRow["TitheRecordDate"] = dateTime.Text;
